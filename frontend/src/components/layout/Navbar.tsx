...
//   { label: 'Səhmləri kəşf et', href: '/explore' },
//   { label: 'Öyrən', href: '/learn' },
//   { label: 'Simulyator', href: '/simulator' },
// ];
...
//   return (
//     <nav className="bg-[#fbf8f2] border-b border-gray-200 shadow-sm">
//       <div className="flex items-center justify-between px-4 md:px-8 py-4">
        
//         {/* Logo */}
//         <Link to="/" className="flex items-center gap-3">
//           <img src="/logo.png" alt="Sehmaz Logo" className="h-9 md:h-10 w-auto" />
//           <span className="text-lg md:text-xl font-black">
//             SEHM<span className="text-[#0a0a0a]">AZ</span>
//           </span>
//         </Link>

//         {/* Desktop menu */}
//         <div className="hidden md:flex items-center bg-[#f0ede6] rounded-full px-1.5 py-1.5 gap-1 border border-gray-200/50">
//           {navLinks.map((link) => (
//             <NavLink
//               key={link.label}
//               to={link.href}
...
//           <button className="text-sm font-bold text-gray-700 hover:text-black">
//             Daxil ol
//           </button>
//           <button className="px-6 py-2.5 text-sm font-bold text-white bg-black rounded-full hover:bg-gray-800">
//             Qeydiyyat
//           </button>
//         </div>
...
//             <button className="flex-1 py-2 text-sm font-bold bg-gray-200 rounded-lg">
//               Daxil ol
//             </button>
//             <button className="flex-1 py-2 text-sm font-bold text-white bg-black rounded-lg">
//               Qeydiyyat
//             </button>
//           </div>
//         </div>
